...
public class BuyProductPaymentFragment  extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View rootView = inflater.inflate(R.layout.fragment_product_payment, container, false);
...
//        mWebView.loadUrl("file:///android_asset/remita-inline-sample.html");
//        mWebView.addJavascriptInterface(new WebViewJavaScriptInterface(getActivity()), "app");
        //mWebView.addJavascriptInterface();
//        mWebView.loadUrl("javascript:setDemoData();");

//        mWebView.evaluateJavascript("javascript:setDemoData(\"mehul\",\"santoki\",\"mehul@gmail.com\",\"1000\");", new ValueCallback<String>() {
//            @Override
//            public void onReceiveValue(String s) {
//                // Do what you want with the return value
//
//
//                Log.e("WEb response",""+s);
//            }
//        });
    ...
    public void onSuccess(String method, String response) {
        ...
        if(method.contains(paymentUrl)) {
            ...
            if(remitaPaymentResponse.getResponseCode().equals("00")){
    ...
    private void getWebUrl(){
        ...
        try {
            ...
            jsonBody.put("returnUrl","https://www.google.com");
            callApis(getActivity(),URL,jsonBody);
...
//            Toast.makeText(context, message,Toast.LENGTH_SHORT).show();
    ...
    private class WebViewClient extends android.webkit.WebViewClient {
        ...
        public void onPageStarted(WebView view, String url, Bitmap favicon) {
            ...
            if(url.contains("https://www.google.com")){
                ...
                callGetApi(getActivity(),traUrl,true,shaKey);
            }
        }
    ...
    public void onClickConfirm() {
        ...
        AppSubmittedFragment fragment = new AppSubmittedFragment();
